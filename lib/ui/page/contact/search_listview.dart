...
class GroupTableView extends StatefulWidget {
  ...
  GroupTableView(
      ...
      required this.sectionFooterBuilder,
      this.refreshWidget,
      this.controller,
    ...
    Future.delayed(Duration.zero, () {
      ...
      if (widget.style == ViewStyle.group) {
        _controller?.addListener(() {
          double offsetY = _controller?.offset ?? 0;
          int _currentIndex = -1;
          ...
          if (offsetY <= 0.0) {
            ...
            floating = true;
            for (int section = sectionList.length - 1;
                section >= 0;
                section--) {
            ...
            if (_currentIndex < 0 && currentIndex >= 0) {
              ...
              if (key.currentContext == null) {
                ...
                _size =
                    Size(_size.width, sectionList[currentIndex].headerHeight);
              } else {
            ...
            if (_currentIndex >= 0) {
              if ((_currentIndex + 1) < sectionList.length) {
                ...
                if (nextGlobalKey.currentContext != null) {
                  RenderBox nextRenderBox = nextGlobalKey.currentContext!
